...
java -cp cellserver.jar:jackson-annotations-2.15.2.jar:jackson-core-2.15.2.jar:jackson-databind-2.15.2.jar:portaltools.jar:s2-geometry-java.jar:vecmath.jar:guava.jar:json-java.jar $mainclass "$@"
